...
const GetStarted = () => {
  return (
    <section className='w-full min-h-screen bg-[#F36400]'>
      <div className='max-w-[1250px] mx-auto px-5 py-[100px] flex flex-col xl:flex-row justify-between items-center gap-4'>
          <div className='w-full xl:w-[50%] xl:h-[663px] flex flex-col gap-6'>
              <h1 className='text-[1.75rem] text-white leading-[43px] font-semibold text-center xl:text-left'>Ready to Get Started?</h1>
              <p className='w-full xl:w-[523px] text-white font-normal leading-[43px] text-center xl:text-left text-[1.3rem]'>
          ...
          <div className='w-full flex justify-center items-center xl:w-[50%]'>
              <div className='bg-[#FBFBFB] flex flex-col justify-center items-center rounded w-full relative lg:w-[626px] h-[660px] gap-4 p-[10px] md:p-[25px] lg:p-[50px]'>
                  <div className='bg-main absolute top-3 left-0 w-full lg:w-[625px] rounded-lg h-[6px]'></div>
                  <h1 className='leading-[43px] text-main font-semibold text-[1.75rem] text-center xl:text-left w-full'>Book a Consultation for Free</h1>
                  ...
                  <div className='bg-[#F0F0F0B2] h-[463px] w-full lg:w-[564px] flex flex-col justify-center items-center gap-[4em]'>
                      ...
                      <button className='bg-main gap-[10px] p-[10px] w-full lg:w-[298px] rounded flex justify-center items-center h-[58px] text-white' type="submit">Request Consultation</button>
                  </div>
                  <div className='bg-main absolute bottom-3 left-0 w-full lg:w-[625px] rounded-lg h-[6px]'></div>
              </div>
          </div>
      </div>
    </section>
